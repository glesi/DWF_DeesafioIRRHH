...
public class Conexion {
    private static final String URL = "jdbc:sqlserver://DESKTOP-US48LBG\\SQLEXPRESS; database=UDB_RRHH;integratedSecurity=true;encrypt=optional;trustServerCertificate=true";
